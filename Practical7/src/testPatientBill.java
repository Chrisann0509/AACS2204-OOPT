...
public class testPatientBill {
    public static void main(String[] args) {
        ...
        PatientBill[] patientBillArray = {new Inpatient(1000,50,'S',2,"V1001","Ali"),new Inpatient(1500,150,'P',7,"V1002","Abu"),new Outpatient(50,"V1003","Siti"),new Outpatient(50,"V1004","Ahmad")};
